      ...
      <div className="min-w-screen min-h-screen flex items-center p-5 lg:p-20 overflow-hidden relative">
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full md:w-1/2">
            <div className="mb-10 lg:mb-20 flex gap-2 items-center">
              <img src={logo} alt="logo" />
              <span className="text-3xl font-semibold font-crimson">Premium</span>
            </div>
            ...
            <div className="mb-20 md:mb-0 ">
              <Link
                to="/home"
                className="text-xl font-bold outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600"
              >
          ...
          <div className="w-full md:w-1/2 text-center">
            ...
            >
              <path className="fill-[#fff]" d="M0 0h500v500H0z" id="BACKGROUND" />
              <g id="OBJECTS">
                <path
                  className="fill-[#b5dfea]"
                ...
                />
                <path
                  className="fill-[#90cedd] opacity-[.55]"
                ...
                <g>
                  ...
                  />
                  <path
                    className="fill-[#efaa3a]"
                    d="M113.53 177.21l1.47 3.22-.71 9.71-.02.03-1.67-2.45z"
                  />
                  <path
                    className="opacity-[.29] fill-[#f98d2b]"
                ...
                <g>
                  ...
                  />
                  <path className="fill-[#ff9f50]" d="M89.96 256.94l.64-4.02H58.1l.64 4.02z" />
                  <path
                    className="fill-[#ff9f50]"
                    d="M82.73 252.92l-3.86 24.27a3.792 3.792 0 0 1-3.74 3.2H83c1.86 0 3.45-1.35 3.74-3.2l3.86-24.27h-7.87z"
                  />
                </g>
                <g>
                  <path className="fill-[#ffbf4d]" d="M167.86 209.64h146.86v29.86H167.86z" />
                  <path
                    className="opacity-[.29] fill-[#f98d2b]"
                    d="M167.86 209.64h146.86v7.25H167.86z"
                  />
                  <path
                    className="fill-[#f77e2d]"
                  ...
                  />
                  <path className="fill-[#79c9e8]" d="M186.14 239.5h10.35v40.83h-10.35z" />
                  <path className="fill-[#49b4d6]" d="M194.15 239.5h2.35v40.83h-2.35z" />
                  <path className="fill-[#79c9e8]" d="M286.9 239.5h10.35v40.83H286.9z" />
                  <path
                    className="fill-[#49b4d6]"
                    d="M294.19 239.5h3.06v40.83h-3.06zM186.14 239.47h10.35v5.14h-10.35z"
                  />
                  <path className="fill-[#49b4d6]" d="M286.9 239.47h10.35v5.14H286.9z" />
                  <path className="fill-[#79c9e8]" d="M186.14 204.97h10.35v4.64h-10.35z" />
                  <path className="fill-[#49b4d6]" d="M194.15 204.97h2.35v4.64h-2.35z" />
                  <path className="fill-[#79c9e8]" d="M286.9 204.97h10.35v4.64H286.9z" />
                  <path
                    className="fill-[#49b4d6]"
                    d="M294.19 204.97h3.06v4.64h-3.06zM186.14 209.03h10.35v.58h-10.35z"
                  />
                  <path className="fill-[#49b4d6]" d="M286.9 209.03h10.35v.58H286.9z" />
                  <path
                    className="fill-[#0582c1]"
                  ...
                  <path className="opacity-[.55]" d="M171.96 222.56H312.2v14.94H171.96z" />
                  <ellipse
                ...
                <g>
                  ...
                  />
                  <path className="fill-[#79c9e8]" d="M319.85 272.72h53.57v7.57h-53.57z" />
                  <path className="fill-[#49b4d6]" d="M361.85 272.72h11.57v7.57h-11.57z" />
                  <path
                    className="opacity-[.29] fill-[#f98d2b]"
                ...
                <g>
                  ...
                  />
                  <circle className="fill-[#ffbf4d]" cx="97.11" cy="40.45" r="26.45" />
                  <path
                    className="fill-[#ff9f50]"
            ...
            <p className="text-xs text-gray-300">©2022 HN22_REACT01_G2. All rights reserved.</p>
          </div>
        </div>
